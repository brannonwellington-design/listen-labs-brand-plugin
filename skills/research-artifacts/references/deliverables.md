...
Every anatomy inherits the Responsive physics in SKILL.md: each has a phone composition, not just a desktop one. Where an anatomy is naturally wide, its mobile strategy is named below.
